...
public class TCCP_1 extends baseClass {
	...
	public void myTest(Map<String, String> excelTestData) throws Exception {
		...
		try {
			...
			String fromMonthYear = date3.month + " " + date3.year;
			Iween_FutureDates.DateResult date4 = dateResults.get("datePlus4");
			String returnMonthYear = date4.month + " " + date4.year;
  	   	    test.log(Status.INFO, "Flight OnWardDate:" +" "+date3.day+" "+fromMonthYear);
			...
			Thread.sleep(5000);
			SearchPage.searchFightsOnHomePage(departFrom,goingTo,date3.day,fromMonthYear,adultsCounts,childCount,infantsCount);    
		...
		//	SearchPage.validateAirlineFilter(selectAirlineReturn,test);
